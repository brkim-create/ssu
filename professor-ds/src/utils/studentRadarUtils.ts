...
import type { StudentCompetency, RadarDataItem } from '../data/mockData';
...
export const getStudentRadarPO = (student: StudentCompetency): RadarDataItem[] => {
  ...
  return Object.entries(poMapping).map(([subject, { base, offset }]) => ({
    ...
    deptAvg: PO_DEPT_AVG[subject as keyof typeof PO_DEPT_AVG],
    totalAvg: PO_TOTAL_AVG[subject as keyof typeof PO_TOTAL_AVG],
  }));
};
