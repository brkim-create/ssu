          ...
          {complaintCategories.map((cat) => (
            <button
              ...
              onClick={() => {
                ...
                } else if (cat.name === '학생 장학') {
                  setChatHistory([
                    { type: 'bot', message: '안녕하세요! 학생 장학 관련 문의를 도와드리겠습니다. 💰' },
                    { type: 'bot', message: '어떤 장학금에 대해 문의하시나요?' }
                  ]);
                } else if (cat.name === '학생 복지') {
                  setChatHistory([
                    { type: 'bot', message: '안녕하세요! 학생 복지 관련 문의를 도와드리겠습니다. 🏥' },
                    { type: 'bot', message: '어떤 복지 시설에 대해 문의하시나요?' }
                  ]);
                } else if (cat.name === '수업 및 학사') {
                  setChatHistory([
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-end justify-center">
          <div className="bg-white w-full max-w-md h-[90vh] flex flex-col rounded-t-3xl animate-slide-up">
            ...
            <div className="shrink-0 p-4 border-b border-gray-200 bg-gradient-to-r from-red-500 via-pink-500 to-orange-400 text-white rounded-t-3xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-bold">{currentCategory} 문의</h3>
                    <p className="text-xs opacity-90">챗봇 상담</p>
                  </div>
                </div>
                <button 
                  onClick={() => {
                    // 시설 및 환경 외에는 완료 상태로 저장
                    if (currentCategory !== '시설 및 환경' && chatAnswers && Object.keys(chatAnswers).length > 0) {
                      setSuccessMessage('문의가 완료되었습니다!');
            ...
            <div ref={chatScrollRef} className="flex-1 overflow-y-auto p-4 space-y-3">
              ...
              {/* 버튼 선택지 */}
              {chatStep === 0 && currentCategory === '시설 및 환경' && (
              ...
              {chatStep === 0 && currentCategory === '학생 장학' && (
                <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              {chatStep === 0 && currentCategory === '학생 복지' && (
                <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              {chatStep === 0 && currentCategory === '수업 및 학사' && (
                <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              {/* 시설 및 환경 - Step 1 */}
              {chatStep === 1 && currentCategory === '시설 및 환경' && (
                <div className="pt-2">
                  <input
                    type="text"
                    value={userInput}
              ...
              {/* 학생 장학 - Step 1 */}
              {chatStep === 1 && currentCategory === '학생 장학' && (
                <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              {/* 학생 복지 - Step 1 */}
              {chatStep === 1 && currentCategory === '학생 복지' && (
                <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              {/* 수업 및 학사 - Step 1 */}
              {chatStep === 1 && currentCategory === '수업 및 학사' && (
                <div className="pt-2">
              ...
              {/* 시설 및 환경 - Step 2 */}
              {chatStep === 2 && currentCategory === '시설 및 환경' && (
                <div className="pt-2">
                  <input
                    type="text"
                    value={userInput}
              ...
              {/* 학생 장학 - Step 2 */}
              {chatStep === 2 && currentCategory === '학생 장학' && (
                <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              {/* 시설 및 환경 - Step 3 */}
              {chatStep === 3 && currentCategory === '시설 및 환경' && (
                <div className="grid grid-cols-2 gap-2 pt-2">
              ...
              {/* 시설 및 환경 - Step 4 */}
              {chatStep === 4 && currentCategory === '시설 및 환경' && (
                <div className="pt-2">
                  <textarea
                    value={userInput}
                    onChange={(e) => setUserInput(e.target.value)}
...
상세: ${finalAnswers.detail}
              ...
              {chatStep === 5 && currentCategory === '시설 및 환경' && (
              ...
              {chatStep === 99 && currentCategory !== '시설 및 환경' && (
                <div className="pt-2">
                  <button
                    onClick={() => {
                      setSuccessMessage('문의가 완료되었습니다!');
