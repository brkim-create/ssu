...
import { X, FileText, Upload, RotateCw, Trash, CircleHelp } from "lucide-react";
import { getIcon } from "@/utils/iconMapper";
import { ComplaintCategory } from "@/data/mockData";
          ...
          <div className="space-y-4 pb-4">
            <div>
              ...
              <input
                ...
                className="w-full p-4 border border-gray-200 rounded-md focus:outline-none focus:border-blue-500 text-sm"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-4 border border-gray-200 rounded-md focus:outline-none focus:border-blue-500 resize-none text-sm"
              />
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              ...
              <label className="flex items-start gap-3 mb-4 cursor-pointer">
                ...
                <span className="text-gray-700">
                  <span className="font-medium text-sm">익명으로 민원</span>
                  <br />
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-gray-700">
                  <span className="font-medium text-sm">처리 알림 수신 동의</span>
                  <br />
                  <span className="text-xs text-gray-500">
